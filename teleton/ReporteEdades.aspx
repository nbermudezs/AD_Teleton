<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteEdades.aspx.cs" Inherits="ReporteEdades" %>
            ...
            <fieldset id="Seguimiento">
                ...
                <ul class="list">
                    ...
                    <li class="field">
                        <div class="fieldIzquierdo">
                            Edad inicial
                            <asp:TextBox ID="edad1" runat="server"></asp:TextBox>
                        </div>

                        <div class="fieldIzquierdo">
                            Edad Final
                            <asp:TextBox ID="edad2" runat="server"></asp:TextBox>
                        </div>
