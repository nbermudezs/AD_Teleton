<%@ Page Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Reportes_Instruccion.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div id = "content">
        <div id="content3">
            <div id = "titulo">
                <h1>Reporte por Nivel de Instruccion</h1>
            </div>
