<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="Reporte_Procedencia.aspx.cs" Inherits="Reporte_Procedencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div id = "content">
        <div id="content3">
            <div id = "titulo">
                <h1>Reporte de pacientes por procedencia</h1>
            </div>
        </div>
        ...
        <div id="navcenter">
            <fieldset id="Seguimiento">
                ...
                <ul class="list">
                    ...
                    <li class="field">
                        <div class="fieldIzquierdo">
                            <asp:Label runat="server" ID="lblDoctor" Text="Procedencia:"></asp:Label>
                            <asp:DropDownList runat="server" ID="ddlProcedencia" 
                                Width="50%">
                            </asp:DropDownList>
                        </div>
        ...
        <div>
            <fieldset>
                ...
                <asp:Panel runat="server" ID="gridPanel" ScrollBars="Auto" CssClass="panel">
                    <asp:GridView ID="gvProcedencia" runat="server" CssClass="Grid" EmptyDataText="----Su busqueda no genero resultados intente con otra fecha.----"
