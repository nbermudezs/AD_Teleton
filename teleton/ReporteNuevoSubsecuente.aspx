<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReporteNuevoSubsecuente.aspx.cs" Inherits="ReporteNuevoSubsecuente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div id = "content">
        <div id="content3">
            <div id = "titulo">
                <h1>Reporte de Pacientes Nuevos o Subsecuentes</h1>
            </div>
        </div>
                ...
                <ul class="list">
                    ...
                    <li class="field">
                        <div class="fieldIzquierdo">
                            ...
                            <br />
                            <br />
                            Condicion de Pacientes:<br />
                            <br />
                            <asp:RadioButtonList ID="rbList" runat="server">
                                <asp:ListItem Selected="True">Nuevo</asp:ListItem>
                                <asp:ListItem>Subsecuente</asp:ListItem>
                ...
                <ul class="list">
                    <li class="field">
                        <asp:Button runat="server" ID="btExportar" Text="Exportar a Excel" 
                            CssClass="boton" Visible="false" onclick="btExportar_Click1" />
                    </li>
                </ul>
                <asp:Panel runat="server" ID="gridPanel" ScrollBars="Auto" CssClass="panel">
                    <asp:GridView ID="gvReporteNSPaciente" runat="server" 
    CssClass="Grid" EmptyDataText="----Su busqueda no genero resultados intente con otra fecha.----"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Codigo Int. Diag." 
                                DataField="codigoInternacional" />
